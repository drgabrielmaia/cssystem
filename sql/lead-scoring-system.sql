-- ============================================
-- LEAD SCORING AND AUTO-DISTRIBUTION SYSTEM
-- ============================================
-- Author: Gabriel Maia
-- Date: 2024-02-13
-- Description: Complete implementation of lead scoring and automatic distribution system
-- ============================================
...
BEGIN
  ...
  -- Map status_contrato to ativo for compatibility
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
...
-- ============================================
-- STEP 2: Create audit/history table
-- ============================================
...
-- ============================================
-- STEP 3: Lead Score Calculation Function
-- ============================================
...
-- ============================================
-- STEP 4: Auto-assign Lead to Closer Function
-- ============================================
...
-- ============================================
-- STEP 5: Trigger for Automatic Score Calculation
-- ============================================
...
-- ============================================
-- STEP 6: Trigger for Automatic Lead Assignment
-- ============================================
...
-- Test function to calculate scores for existing leads
...
-- Function to recalculate all lead scores
...
-- Function to get lead distribution statistics
...
-- ============================================
-- STEP 9: Sample Test Execution
-- ============================================

-- Uncomment the following lines to test the system:

-- Test scoring and assignment on 5 recent leads
...
-- ============================================
-- END OF LEAD SCORING SYSTEM IMPLEMENTATION
-- ============================================