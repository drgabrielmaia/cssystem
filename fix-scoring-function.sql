-- Fix the scoring function to return the correct field names
...
BEGIN
    ...
    CASE submission_data->>'capacidade_investimento'
        ...
        WHEN 'Não tenho capacidade de investimento no momento' THEN investimento_score := -10;
        ELSE investimento_score := 0;
    END CASE;
    ...
    CASE submission_data->>'situacao_trabalho'
        ...
        WHEN 'Atualmente desempregado' THEN situacao_score := -5;
        ELSE situacao_score := 5;
    END CASE;
    ...
    CASE submission_data->>'urgencia_mudanca'
        ...
        WHEN 'Não tenho pressa, é mais curiosidade' THEN urgencia_score := -3;
        ELSE urgencia_score := 5;
    END CASE;
    ...
    CASE submission_data->>'objetivo_12_meses'
        ...
        WHEN 'Ainda não tenho clareza sobre meus objetivos' THEN objetivo_score := -2;
        ELSE objetivo_score := 5;
    END CASE;
    ...
    CASE submission_data->>'ja_investiu_mentoria'
        ...
        WHEN 'Não, e ainda tenho receio de investir' THEN mentoria_score := -3;
        ELSE mentoria_score := 2;
    END CASE;
...
-- Update the trigger function to use the correct field names
...
BEGIN
    ...
    IF NEW.template_slug = 'qualificacao-medica' THEN
        ...
        -- Calculate score using the updated function
...
SELECT 'SCORING FUNCTION AND TRIGGER UPDATED' as status;