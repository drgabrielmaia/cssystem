...
// Configuração do Z-API WhatsApp (do .env.local)
const ZAPI_CONFIG = {
...
async function sendDailyMessageToAdmins() {
    ...
    try {
        ...
        if (!isConnected) {
            console.log('⚠️ WhatsApp não está conectado via Z-API. Continuando mesmo assim...\n');
        }
        ...
        for (const org of organizations) {
            ...
            // Aguardar 3 segundos entre envios para evitar rate limiting
