...
-- 1. Adicionar campos de gênero, especialidade e updated_at
...
COMMENT ON COLUMN mentorados.updated_at IS 'Data e hora da última atualização do registro';

-- 5. Exibir estrutura atualizada
SELECT column_name, data_type, is_nullable, column_default
FROM information_schema.columns
WHERE table_name = 'mentorados'
AND column_name IN ('genero', 'especialidade', 'updated_at')
