...
type StatusType = 'confirmed' | 'pending' | 'cancelled' | 'completed' | 'new' | 'contacted' | 'qualified' | 'hot' | 'converted' | 'lost'
...
export const StatusBadge = ({ status, label }: StatusBadgeProps) => {
  const statusConfig = {
    ...
    qualified: { label: 'Qualificado', bg: 'bg-purple-100', text: 'text-purple-700', dot: 'bg-purple-500' },
