...
export type TemplateCategory = 'testimonial' | 'comparison' | 'motivational' | 'quote' | 'cta' | 'storytelling' | 'data-story' | 'dark-narrative' | 'editorial-slide' | 'cover-overlay' | 'pure-editorial';
