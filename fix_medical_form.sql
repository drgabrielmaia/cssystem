-- Corrigir estrutura do formulário médico
-- O erro é que fields deve ser um array, não um objeto com fields

-- Deletar o template com problema
DELETE FROM form_templates WHERE slug = 'qualificacao-medica';

-- Inserir template corrigido
