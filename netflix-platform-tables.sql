...
-- ===============================================
-- 9. Create recommendation function
-- ===============================================
...
-- Update some existing modules with cover images and features (example)
-- Uncomment and customize based on your existing data
/*
UPDATE video_modules
SET
  cover_image_url = 'https://example.com/covers/module1.jpg',
  featured = true,
  difficulty_level = 'beginner',
  tags = ARRAY['marketing', 'iniciante', 'vendas']
WHERE title LIKE '%Marketing%'
LIMIT 1;

UPDATE video_modules
SET
  cover_image_url = 'https://example.com/covers/module2.jpg',
  featured = true,
  difficulty_level = 'intermediate',
  tags = ARRAY['gestão', 'liderança']
WHERE title LIKE '%Gestão%'
LIMIT 1;
*/
